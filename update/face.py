...
def train(training_dir, model_save_path=None, n_neighbors=None, knn_algo='ball_tree', verbose=False):
    ...
    for class_dir in os.listdir(training_dir):
        ...
        for img_path in image_files_in_folder(os.path.join(training_dir, class_dir)):
...
if __name__ == "__main__":
    ...
    classifier = train("data/training", model_save_path="trained_knn_model.clf", n_neighbors=2)
    #time.sleep(30)
    ...
    for image_file in os.listdir("data/test"):
        ...
        show_prediction_labels_on_image(count,os.path.join("data/test", image_file), predictions)
        count = count + 1